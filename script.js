const productData = {
  ...
  macbook: {
    title: "13 吋 MacBook Air (M5)",
    price: "ePrice 建議售價 NT$ 35,900 起",
    description: "目前推薦機型為 13 吋 MacBook Air（M5），兼顧便攜、續航與日常工作效率。",
    features: [
      "ePrice 建議售價 NT$ 35,900 起",
      "13.6 吋、16GB 記憶體、512GB SSD 起",
      "適合做企業採購與行動工作主力",
    ],
    tags: ["ePrice 建議售價", "M5 晶片", "13 吋 Air"],
    cart: {
      id: "index-macbook-air-13-m5",
      name: "13 吋 MacBook Air (M5)",
      spec: "16GB / 512GB SSD",
      price: 34823,
    },
  },
